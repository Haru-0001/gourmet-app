...
const RangeSlider = () => {
    return (
        <div className="relative mb-6 w-9/12">
            ...
            <span className="text-sm text-gray-500 absolute start-[-12px] -bottom-6">&nbsp;300m</span>
            <span className="text-sm text-gray-500 absolute start-1/4 -translate-x-1/2 -bottom-6">&emsp;500m</span>
            ...
            <span className="text-sm text-gray-500 absolute end-[-12px] -bottom-6">3000m</span>
        </div>
    );
}
export { RangeSlider }